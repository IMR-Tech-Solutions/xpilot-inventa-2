  ...
  const handleSearch = (value: string) => {
    ...
    const filtered = products.filter(
      (product) =>
        ...
        String(product.current_stock ?? "").includes(searchTerm) ||
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (price: string | null) => (
        <span className={price ? "text-green-600 font-medium" : "text-gray-400"}>
    ...
    },
    {
      ...
      key: "current_stock",
      render: (stock: number) => (
        <span style={{ color: stock === 0 ? "red" : "inherit", fontWeight: stock === 0 ? 600 : 400 }}>
          {stock === 0 ? "No Stock" : stock}
        </span>
      ),
    },
    {
