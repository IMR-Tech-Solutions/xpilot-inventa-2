...
import { getProductWiseShopSalesRegisterService } from "../../services/reportservices";
import { handleError } from "../../utils/handleError";

interface ProductShopSalesRow {
  sr_no: number;
  date: string;
  order_no: string;
...
const ProductWiseShopSalesRegister = () => {
  const [rows, setRows] = useState<ProductShopSalesRow[]>([]);
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await getProductWiseShopSalesRegisterService({
  ...
  return (
    <>
      <PageMeta
        title="Product Wise Shop Sales Register"
        description="Product Wise Shop Sales Register"
      />
      <PageBreadcrumb pageTitle="Product Wise Shop Sales Register" />
...
export default ProductWiseShopSalesRegister;
