...
import { getSalesRegisterService } from "../../services/reportservices";
...
const SalesRegister = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await getSalesRegisterService({
  ...
  return (
    <>
      <PageMeta title="Sales Register" description="Sales Register Report" />
      <PageBreadcrumb pageTitle="Sales Register" />

      <ButtonComponentCard title="Sales Register" buttonlink="" buttontitle="">
        {/* Filters */}
